...
// create an array with the length values of all strings
const animalStringsLengths = animalStrings.map((animal) => {
  return animal.length;
});
console.log(animalStringsLengths);

//sum up with reduce
const sumOfAllAnimalCharacters = animalStringsLengths.reduce((a, b) => a + b);
console.log(sumOfAllAnimalCharacters);

//method chaininggggggggg
const sumOfAllAnimalCharactersChain = animalStrings
  .map((animal) => {
    return animal.length;
  })
  .reduce((a, b) => a + b);
console.log(sumOfAllAnimalCharactersChain);
