...
// EXERCISE 7
// Write a function reverseArrayWithoutMutating that takes an array as an argument and
//returns a new array containing all of the items that are in the array that was passed in but in reverse order.
...
export function reverseArrayWithoutMutating(arr) {
  ...
  let newArr = [element3, element2, element1];
  return newArr;
}
...
// EXERCISE 8
// Develop a function mergeAndSortArrays that takes two arrays of numbers as arguments and returns
//a new array that is the result of merging the two arrays and sorting the elements in ascending order.
...
export function mergeAndSortArrays(array1, array2) {
  const [element1, element2, element3] = array1;
  const [elementI, elementII, elementIII] = array2;
  let newArray = [
    element3,
    elementIII,
    element1,
